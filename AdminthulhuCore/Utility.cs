...
namespace Adminthulhu {
    ...
    public static class Utility {
        ...
        public static IMentionable ConvertMentionToObject(string mention) {
            ...
            try {
                switch (extracted) {
                    ...
                    case var ext when ext.Substring (0, 3) == "<@&": // Role mentions
                        ...
                        return GetServer ().GetRole (roleID);

                    case var ext when ext.Substring (0, 3) == "<@!": // Nickname mentions
                        return GetServer ().GetUser (ulong.Parse (ext.Substring (3)));

                    case var ext when ext.Substring (0, 2) == "<@": // Username mentions
                        return GetServer ().GetUser (ulong.Parse (ext.Substring (2)));

                    case var ext when ext.Substring (0, 2) == "<#": // Channel mentions
                        return GetServer ().GetTextChannel (ulong.Parse (ext.Substring (2)));
