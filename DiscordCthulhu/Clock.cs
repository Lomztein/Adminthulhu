...
namespace DiscordCthulhu {
    public class Clock {
        ...
        public IClockable[] clockables = new IClockable[] {new AutomatedEventHandling (), new AutomatedTextChannels (), /*new UserActivityMonitor ()*/ new Birthsdays (), new AutomatedWeeklyEvent ()};
